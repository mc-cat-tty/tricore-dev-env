...
/* ================================================================================================
 * SECTIONS: Fixed memory Allocations for Dma uninitialized data
 * ==============================================================================================*/

SECTIONS
{
    .dma.dspr0bss (0x70000000) (NOLOAD):
    {
        *(.dma.dspr0bss)
        *(.dma.dspr0bss.*)
        . = ALIGN(4);
    ...
    .dma.dlmu0bss (0xB0000000) (NOLOAD):
    {
        *(.dma.dlmu0bss)
        *(.dma.dlmu0bss.*)
        . = ALIGN(4);
...
SECTIONS
{
    .rodata : ALIGN(4)
    {
        ...
        *(.gnu.linkonce.r.*)
        ...
        LONG(0 + ADDR(.dma.dspr0bss));    LONG(SIZEOF(.dma.dspr0bss));
        LONG(0 + ADDR(.dma.dlmu0bss));    LONG(SIZEOF(.dma.dlmu0bss));
